...
BYTE XSTL_SERV_IP[4] = { 73, 223, 94, 152 };//73.223.94.152
WORD XSTL_SERV_PORT = 53;//port here

// Unobfuscated = "XBLSTEALTH"
#define XSTL_SALT_KEY_XOR_VALUE 0x7A
BYTE XSTL_SALT_KEY[] = { 0x22, 0x38, 0x36, 0x29, 0x2E, 0x3F, 0x3B, 0x36, 0x2E, 0x32 };//they still use this?
