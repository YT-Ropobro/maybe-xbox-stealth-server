...
namespace Base
{
    internal class mysql
    {
        ...
        public static void iniLogin()
        {
            ...
            mysql.serverAddr = ""; // enter your mysql server backend here 
            mysql.database = "";//Don't change this ether the database name should be template
            mysql.username = "";//Don't change this ether.    
